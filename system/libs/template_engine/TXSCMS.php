 ...
 */
use XSCMS\ProviderInterface;
use XSCMS\Template;

/**
 * XSCMS Template Engine
 *
 *
 */
class XSCMS
{
    ...
    /* Default parsers */
    const DEFAULT_CLOSE_COMPILER = 'XSCMS\Compiler::stdClose';
    const DEFAULT_FUNC_PARSER    = 'XSCMS\Compiler::stdFuncParser';
    const DEFAULT_FUNC_OPEN      = 'XSCMS\Compiler::stdFuncOpen';
    const DEFAULT_FUNC_CLOSE     = 'XSCMS\Compiler::stdFuncClose';
    const SMART_FUNC_PARSER      = 'XSCMS\Compiler::smartFuncParser';
    ...
    /**
     * @var XSCMS\Render[] Templates storage
     */
    ...
    protected $_modifiers = array(
        ...
        "lower"       => 'strtolower',
        "low"         => 'strtolower',
        "date_format" => 'XSCMS\Modifier::dateFormat',
        "date"        => 'XSCMS\Modifier::date',
        "truncate"    => 'XSCMS\Modifier::truncate',
        "escape"      => 'XSCMS\Modifier::escape',
        "e"           => 'XSCMS\Modifier::escape', // alias of escape
        "unescape"    => 'XSCMS\Modifier::unescape',
        "strip"       => 'XSCMS\Modifier::strip',
        "length"      => 'XSCMS\Modifier::length',
        "iterable"    => 'XSCMS\Modifier::isIterable',
        "replace"     => 'XSCMS\Modifier::replace',
        "ereplace"    => 'XSCMS\Modifier::ereplace',
        "match"       => 'XSCMS\Modifier::match',
        "ematch"      => 'XSCMS\Modifier::ematch',
        "split"       => 'XSCMS\Modifier::split',
        "esplit"      => 'XSCMS\Modifier::esplit',
        "join"        => 'XSCMS\Modifier::join',
        "in"          => 'XSCMS\Modifier::in',
    );
    ...
    protected $_actions = array(
        'foreach'    => array( // {foreach ...} {break} {continue} {foreachelse} {/foreach}
            ...
            'open'       => 'XSCMS\Compiler::foreachOpen',
            'close'      => 'XSCMS\Compiler::foreachClose',
            'tags'       => array(
                'foreachelse' => 'XSCMS\Compiler::foreachElse',
                'break'       => 'XSCMS\Compiler::tagBreak',
                'continue'    => 'XSCMS\Compiler::tagContinue',
            ),
            'float_tags' => array('break' => 1, 'continue' => 1)
        ),
        'if'         => array( // {if ...} {elseif ...} {else} {/if}
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::ifOpen',
            'close' => 'XSCMS\Compiler::stdClose',
            'tags'  => array(
                'elseif' => 'XSCMS\Compiler::tagElseIf',
                'else'   => 'XSCMS\Compiler::tagElse'
            )
        ),
        'switch'     => array( // {switch ...} {case ..., ...}  {default} {/switch}
            'type'       => self::BLOCK_COMPILER,
            'open'       => 'XSCMS\Compiler::switchOpen',
            'close'      => 'XSCMS\Compiler::switchClose',
            'tags'       => array(
                'case'    => 'XSCMS\Compiler::tagCase',
                'default' => 'XSCMS\Compiler::tagDefault'
            ),
            'float_tags' => array('break' => 1)
        ),
        'for'        => array( // {for ...} {break} {continue} {/for}
            'type'       => self::BLOCK_COMPILER,
            'open'       => 'XSCMS\Compiler::forOpen',
            'close'      => 'XSCMS\Compiler::forClose',
            'tags'       => array(
                'forelse'  => 'XSCMS\Compiler::forElse',
                'break'    => 'XSCMS\Compiler::tagBreak',
                'continue' => 'XSCMS\Compiler::tagContinue',
            ),
            'float_tags' => array('break' => 1, 'continue' => 1)
        ...
        'include'    => array( // {include ...}
            ...
            'parser' => 'XSCMS\Compiler::tagInclude'
        ),
        'insert'     => array( // {include ...}
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagInsert'
        ),
        'var'       => array( // {var ...}
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::setOpen',
            'close' => 'XSCMS\Compiler::setClose'
        ),
        'set'       => array( // {set ...}
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::setOpen',
        ...
        'block'      => array( // {block ...} {parent} {/block}
            'type'       => self::BLOCK_COMPILER,
            'open'       => 'XSCMS\Compiler::tagBlockOpen',
            'close'      => 'XSCMS\Compiler::tagBlockClose',
            'tags'       => array('parent' => 'XSCMS\Compiler::tagParent'),
            'float_tags' => array('parent' => 1)
        ),
        'extends'    => array( // {extends ...}
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagExtends'
        ),
        'use'        => array( // {use}
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagUse'
        ),
        'filter'     => array( // {filter} ... {/filter}
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::filterOpen',
            'close' => 'XSCMS\Compiler::filterClose'
        ),
        'macro'      => array(
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::macroOpen',
            'close' => 'XSCMS\Compiler::macroClose'
        ),
        'import'     => array(
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagImport'
        ),
        'cycle'      => array(
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagCycle'
        ),
        'raw'        => array(
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagRaw'
        ),
        'autoescape' => array( // deprecated
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::escapeOpen',
            'close' => 'XSCMS\Compiler::nope'
        ),
        'escape' => array(
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::escapeOpen',
        ...
        'strip' => array(
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::stripOpen',
            'close' => 'XSCMS\Compiler::nope'
        ),
        'ignore' => array(
            'type'  => self::BLOCK_COMPILER,
            'open'  => 'XSCMS\Compiler::ignoreOpen',
            'close' => 'XSCMS\Compiler::nope'
        ),
        'unset'  => array(
            'type'   => self::INLINE_COMPILER,
            'parser' => 'XSCMS\Compiler::tagUnset'
        )
    );
    ...
    protected $_tests = array(
        ...
        'array'    => 'is_array(%s)',
        'iterable' => '\XSCMS\Modifier::isIterable(%s)',
        'const'    => 'defined(%s)',
    ...
    protected $_accessors = array(
        'get'     => 'XSCMS\Accessor::getVar',
        'env'     => 'XSCMS\Accessor::getVar',
        'post'    => 'XSCMS\Accessor::getVar',
        'request' => 'XSCMS\Accessor::getVar',
        'cookie'  => 'XSCMS\Accessor::getVar',
        'globals' => 'XSCMS\Accessor::getVar',
        'server'  => 'XSCMS\Accessor::getVar',
        'session' => 'XSCMS\Accessor::getVar',
        'files'   => 'XSCMS\Accessor::getVar',
        'tpl'     => 'XSCMS\Accessor::tpl',
        'version' => 'XSCMS\Accessor::version',
        'const'   => 'XSCMS\Accessor::constant',
        'php'     => 'XSCMS\Accessor::php',
        'tag'     => 'XSCMS\Accessor::Tag',
        'fetch'   => 'XSCMS\Accessor::Fetch',
    );

    /**
     * Just factory
     *
     * @param string|XSCMS\ProviderInterface $source path to templates or custom provider
    ...
    {
        if (is_string($source)) {
            $provider = new XSCMS\Provider($source);
    ...
    /**
     * @param XSCMS\ProviderInterface $provider
     */
    public function __construct(XSCMS\ProviderInterface $provider)
    {
     ...
     * @param XSCMS\ProviderInterface $provider provider object
     * @param string $compile_path
     * @return $this
     */
    public function addProvider($scm, \XSCMS\ProviderInterface $provider, $compile_path = null)
    {
     ...
     * @return XSCMS\ProviderInterface
     * @throws InvalidArgumentException
     */
    ...
    {
        \XSCMS\Provider::clean($this->_compile_dir);
        $this->flush();
    }
