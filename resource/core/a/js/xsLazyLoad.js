...
(function() {
	...
	var xsLazyLoad = angular.module('xs.lazyLoad', ['ng']);

	xsLazyLoad.provider('$xsLazyLoad', ['$controllerProvider', '$provide', '$compileProvider', '$filterProvider', '$injector',
	...
	xsLazyLoad.directive('xsLazyLoad', ['$http', '$log', '$xsLazyLoad', '$compile', '$timeout', '$templateCache',
		function($http, $log, $xsLazyLoad, $compile, $timeout, $templateCache) {
			return {
				link: function(scope, element, attr) {
					...
					scope.$watch(attr.xsLazyLoad, function(moduleName) {
						if(moduleName) {
							$xsLazyLoad.load(moduleName).then(function(moduleConfig) {
